...
export default function AboutPage() {
  return (
    <main className="flex flex-col items-center w-full">
      ...
      <div className="flex flex-col gap-[60px] md:gap-[100px] w-full max-w-[50rem] md:max-w-[37.5rem] lg:max-w-[43.75rem] xl:max-w-[50rem] px-6 mt-16 md:mt-[150px] pb-16 md:pb-[150px] mb-[100px]">
        ...
        <div className="flex flex-col gap-4 w-full">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {['Vertical%201.jpg', 'Vertical%202.jpg', 'Vertical%203.jpg', 'Vertical%204.jpg'].map((img, i) => (
              <div key={i} className="aspect-[3/4] overflow-hidden">
                <Image src={`/images/about-compressed/${img}`} alt="" width={0} height={0} sizes="25vw" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
              </div>
            ))}
          </div>
          ...
          <div className="aspect-[4/3] overflow-hidden w-full">
            <Image src="/images/about-compressed/Horizontal%201.jpg" alt="" width={0} height={0} sizes="100vw" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {['IMG_0595.jpg', 'IMG_1226.JPG'].map((img, i) => (
              <div key={i} className="aspect-[3/4] overflow-hidden">
                <Image src={`/images/about-compressed/${img}`} alt="" width={0} height={0} sizes="50vw" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
              </div>
            ))}
          </div>
