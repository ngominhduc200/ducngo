...
export default function Footer() {
  ...
  return (
    <footer id="site-footer" className="sticky bottom-0 w-full z-0 min-h-[80vh] flex flex-col items-center justify-center overflow-hidden">
      <div className="absolute inset-0 bg-blue-950" aria-hidden="true" />
      <div className="relative flex flex-col items-start md:items-center gap-[60px] w-full max-w-[50rem] md:max-w-[37.5rem] lg:max-w-[43.75rem] xl:max-w-[50rem] px-6 antialiased">
