...
export default function Footer() {
  ...
  return (
    <footer id="site-footer" className="sticky bottom-0 w-full z-0 bg-blue-950 min-h-[80vh] flex flex-col items-center justify-center" style={{ transform: 'translateZ(0)' }}>
