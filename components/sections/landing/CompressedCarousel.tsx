...
const PROJECTS = [
  ...
  { id: 'discogs-shop',   label: 'Academic Discogs Shop',                href: 'https://ducngo.framer.website/',                   image: '/images/archive/discogs-shop/preview.webp', video: null as string | null,                             tagline: 'Web Design · Front-End Development · 2022', title: 'Discogs Shop Website Redesigned',                                                                             description: "Built a responsive e-commerce website using HTML and CSS, including product listing features and client information pages, deployed on GitHub Pages.",                                                                                                                                                                                                                                              isArchive: true,  external: true  },
  { id: 'peak-sfu',       label: 'The Peak SFU',                         href: 'https://ducngo.framer.website/the-peak',           image: '/images/archive/the-peak/cover.webp',  video: null as string | null, tagline: 'Graphic Design · 2022–2024',               title: 'The Peak SFU Magazine Spread',                                                                                      description: "Designed magazine spreads, covers, and section layouts for SFU's student newspaper. Transformed written content and illustrations into engaging visual compositions using layout design, typography selection, and colour palette development.",                                                                                                                                                      isArchive: true,  external: true  },
