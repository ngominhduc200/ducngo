...
const PROJECTS = [
  { id: 'peak-create',    label: 'Peak Create Request System',           href: '/project/peak-create',                                video: '/images/peak-create/cover.mp4',        image: null as string | null, tagline: 'Product Design · 2026',                    title: "Streamlining how The Peak's editorial team briefs, tracks, and pays illustrators with Peak Create", description: "At The Peak, illustration requests ran across Sheets, Slack, Gmail, and Drive with no connection between them. I designed Peak Create: a single tool where editors brief, illustrators submit, and the Production Editor tracks everything from request to invoice. Production Editors said it reduced mental load and saw it as a full replacement for how they work today.",                                                                                                                                        isArchive: false, external: false },
  { id: 'airbnb',         label: 'Airbnb Collaborative Trip Planning',   href: '/project/airbnb',                                     image: '/images/airbnb/cover.webp',             video: null as string | null, tagline: 'Product Design · Concept 2026',            title: 'Helping groups align on a place to stay together with Airbnb Collaborative Trip Planning',          description: "Group trip planning happens outside Airbnb, with one person carrying all the links and opinions across separate group chats. I designed Collaborative Trip Planning: a feature where members set preferences, browse with merged group filters, react to listings, and see a ranked summary to align without leaving the app. In testing, all 3 participants completed the full flow without prompting and said the summary made group consensus visible without a separate conversation.",                                                                                                                                                                                              isArchive: false, external: false },
